...
class WLNaviCOnfigImpl: WLNaviControllerConfig {
    var Back_Image: String { return "返回白"}
...
class WLLoginConfigIml: WLLoginConfig {
    ...
    var backIcon: String { return "返回白" }
    
    var goIcon: String { return "" }
    
}

class WLCircleConfigImpl: WLCircleConfig ,WLContentConfig ,WLCommentConfig{
    var broadIcon: String { return "播放"}
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(aaaaaaa(_:)), name: NSNotification.Name(rawValue: DNotificationCircleClick), object: nil)
        
        return true
    }
    
    @objc func aaaaaaa(_ noti: Notification) {
        
        if let userInfo = noti.userInfo {
            
            let circleJson = userInfo["value"] as! [String: Any]
